...
class VacuumCleaner {
    ...
    startCleaning() {
        ...
        console.log('I am cleqning... I have been started: ', this.counterOfStarts, 'times.');
    }
...
console.log(BaseRobot.construcor); // class VacuumCleaner {
    // model = "vacuum cleaner";
    // counterOfStarts = 0;
    // isFull = false;
    // isObstacle = false;
    ...
    // I am cleqning... I have been started: 1 times.
...
// Расширенный класс DancingSeries. С помощью extends мы укаываем от какого класса будем наследоваться.
...
console.log(DancingRobot.__proto__); // VacuumCleaner {constructor: f, switchUVLamp: f}
...
console.log(DancingSeries.prototype); // VacuumCleanrt {constructor: f, switchUVLamp: f}