...
// Хоть мы и не объявляли метод toString в нашей цепочке объектов, но он присутствует и идёт от самого первого объекта (базового), т.к. его прототип - это сам оюъект, и метод toString пришел от него.
