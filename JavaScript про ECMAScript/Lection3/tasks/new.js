...
function createObject(constructor) {
    ...
    // Вернем новый объект, если конструкотор вернул примитивное значение или undefined, иначе вернем то, что вернул конструктор
...
// Сохдадим экземпляр нового объекта
const Samba1 = createObject(Samba, 1014778);
// Проверим устанвку свойств в конструкторе
console.log(Samba1.setPrototypeOf); // 1014778
...
// Посмотрим свойства __proto__ и prototype
console.log(Samba1.__proto__); // {model: "dancing series", power: 200, batterySize: 2100, boxSize: 0.5, workTime: 45, ...}
