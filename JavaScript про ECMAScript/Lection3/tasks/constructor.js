...
// I am cleaning... I have been startd: 1 times
...
// Далее мы можем взаимодействовать с нашим массивом роботов как на удобно, обрабатывать его в циклах, обращаться к каждому роботу по отдельности, и нам понадобилось всего четыре строчки кода, чтобы создать такое количество роботов.

// Объявление базового родительсокго объекта смотри в листинге 1.
// Оъявление DancingSeries смотри в листинге 2.
