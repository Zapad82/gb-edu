...
INSERT INTO `profiles` VALUES 
	...
	('100','m','1990-02-11','100','1974-08-23 15:31:47','Port Mable'); 
...
CREATE FUNCTION vk.delete_user_id(user_id INT)
...
DELIMITER //
CREATE PROCEDURE vk.DeleteUser(IN userId INT)
BEGIN
...
-- Для вызова процедуры достаточно выполнить запрос:
```
...
CREATE TRIGGER CheckCommunityName
BEFORE INSERT ON communities
FOR EACH ROW
BEGIN
    IF LENGTH(NEW.name) < 5 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Название сообщества должно иметь минимум 5 символов.';
    END IF;
END;
