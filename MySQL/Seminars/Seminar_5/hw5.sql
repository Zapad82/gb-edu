...
-- представление, выбирающее группы пользователей
CREATE or replace VIEW v_users_communities AS
...
-- получим группы пользователя из представления 
select *
from v_users_communities
where id = 1;


-- 3. Удалите представление [DROP VIEW]
-- удаление представления
DROP VIEW v_users_communities;
