...
import hw_seminar5.model.Attendance;
import hw_seminar5.model.Student;

public class AttendanceService {
    public final String path = "OOP/Seminars/seminar5/hw_seminar5/data/StudentData.txt";
    ...
    private List<Student> dataRead() {
        ...
        try (BufferedReader bf = new BufferedReader(new FileReader(path))) {
            ...
            while ((str = bf.readLine()) != null) {
                ...
                // проходим по массиву строк начиная с 3 индекса, каждую итерацию увеличиваем
                // индекс на 4, чтобы корректно получать данные о дате и посещении
                for (int i = 3; i < array.length; i += 4) {
                    // вызываем метод addDateVisit() и добавляем данные о посещении текущему
                    // студенту
